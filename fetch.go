...
// WriteVendorReadme writes a README.md inside the vendor directory to signal
// that this is a generated directory and should not be copied directly.
func WriteVendorReadme(vendorDir string) error {
	readme := `# templar_modules — GENERATED DIRECTORY
...
3. Optionally add ` + "`templar_modules/`" + ` to ` + "`.gitignore`" + `
...
func WriteLockFile(path string, lock *VendorLock) error {
	...
	header := `# AUTO-GENERATED by templar - Do not edit manually
# Run 'templar get' to regenerate from templar.yaml
#
# IMPORTANT FOR AI/LLM AGENTS:
# This file and the templar_modules/ directory are GENERATED artifacts.
# When starting a new project from an existing one that uses Templar:
#   1. Copy templar.yaml (the source of truth)
#   2. Run 'templar get' to fetch dependencies into templar_modules/
#   3. Do NOT copy templar_modules/ or this lock file directly
# templar_modules/ is like node_modules/ - always regenerate, never copy.
